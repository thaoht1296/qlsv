...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-teal elevation-4 cl">
    <!-- Brand Logo -->
    <a href="danhsachBaiDang.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
                <a href="danhsachBaiDang.php" class="nav-link active">
                  ...
                  <?php while($row = mysqli_fetch_assoc($baiviet)): ?>
                    <tr>
                      ...
                      <td class="project-actions text-center">
                        <a class="btn btn-primary btn-sm" href="xembaiDangSV.php?baiviet=<?=$row['mabv'];?>">
